...
python3 build0_data_analysis_pipeline_assignment_1.py --data ../data/penguins.csv --target bill_depth_mm --outcome flipper_length_mm --predictors body_mass_g --report_dir reports
--Make sure you are in the correct directory where this script is located when you run the command, and adjust the path to your dataset as needed. The right folder!
